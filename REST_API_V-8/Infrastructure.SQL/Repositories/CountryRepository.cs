...
public class CountryRepository(DemoContext demoContext) : ICountryRepository
{
    private readonly DemoContext _demoContext = demoContext;
    ...
    public async Task<int> UpdateAsync(CountryDto country)
    {
        ...
        return await _demoContext.Countries.Where(x => x.Id == countryEntity.Id)
    ...
    {
        return await _demoContext.Countries.AsNoTracking()
    ...
    {
        return await _demoContext.Countries.Where(x => x.Id == id)
